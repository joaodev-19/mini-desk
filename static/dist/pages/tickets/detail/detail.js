...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    function renderPage() {
        ...
        renderTicketContentActions(elements.ticketActionsContainer, state.ticket, state.user);
    ...
    await init();
    elements.ticketActionsContainer.addEventListener("click", (event) => {
    ...
    if (elements.updateForm &&
        ...
        elements.updateForm.addEventListener("submit", async (event) => {
            ...
            if (submitResponse.status ===
                "error") {
                showToast("Erro ao atualizar", submitResponse.message, "danger");
                return;
            }
            state.ticket =
